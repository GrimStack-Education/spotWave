...
export function UiButton({ className, variant = 'primary', fullWidth, onPress, onClick, isDisabled, disabled, ...props }: UiButtonProps) {
 ...
 className={[
 'min-h-11 rounded-2xl px-5 tracking-[-0.01em] text-white transition-all focus-visible:ring-2 focus-visible:ring-[rgba(var(--sw-accent-2-rgb),0.55)] focus-visible:ring-offset-0',
 fullWidth ? 'w-full' : '',
