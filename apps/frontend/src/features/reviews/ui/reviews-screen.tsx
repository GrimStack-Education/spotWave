...
export function ReviewsScreen() {
 ...
 <UiCard className="space-y-4 p-6"><div className="flex items-center gap-3"><span className="grid h-12 w-12 place-items-center rounded-2xl bg-[rgba(var(--sw-accent-4-rgb),0.16)] text-[var(--sw-accent-3)]"><Star size={20} /></span><div><h2 className="text-2xl tracking-[-0.04em]">Leave a review</h2><p className="text-white/52">Rating {trust.rating} · {trust.reviewsCount} reviews</p></div></div><UiInput aria-label="review" placeholder="Leave your feedback" /><UiButton>Submit review</UiButton></UiCard>
