...
export function EventChatScreen({ eventId }: { eventId: string }) {
 ...
 <p className="flex items-center gap-2 rounded-2xl border border-[rgba(var(--sw-accent-2-rgb),0.24)] bg-[rgba(var(--sw-accent-4-rgb),0.10)] p-4 text-sm text-white/80"><Pin size={16} /> Pinned: meet 10 minutes before start.</p>
